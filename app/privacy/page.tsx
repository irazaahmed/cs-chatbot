...
export const metadata: Metadata = {
  ...
  description: "How CS Chatbot (by Cybrum Solutions) collects, uses, and protects data across the Website and WhatsApp channels.",
        ...
        <div className="prose-invert mt-10 space-y-8 text-sm leading-relaxed text-muted sm:text-base">
          <section>
            ...
            <p className="mt-3">
              ...
              content, then turn it on for their website, their WhatsApp Business number, or both — each
              channel opt-in and independent. This policy covers data collected across all channels, both
              from the tenants who run the chatbot and the visitors/customers who chat with it.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>Channel connection details: their website domain, or their WhatsApp Business number and the access token needed to send and receive messages on their behalf.</li>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>For WhatsApp, the platform-provided sender identifier (phone number) needed to route replies to the right person.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>To send and receive messages on the tenant&apos;s connected WhatsApp account, using OpenAI&apos;s API to generate replies (see Section 5).</li>
          ...
          <section>
            <h2 className="font-heading text-xl font-semibold text-foreground">5. Third parties we use</h2>
            <ul className="mt-2 list-disc space-y-1 pl-5">
              <li><b className="text-foreground">OpenAI</b> — processes chat messages to generate AI replies and text embeddings.</li>
              <li><b className="text-foreground">Meta (WhatsApp Business Platform)</b> — delivers and receives messages for tenants who connect that channel.</li>
          ...
          <section>
            <h2 className="font-heading text-xl font-semibold text-foreground">6. Your choices</h2>
            <p className="mt-3">
