...
export function buildMessages(
  ...
  const system = [
    ...
    "For general questions unrelated to this specific business (small talk, simple factual or " +
      ...
      "of refusing.",
    // Turns the bot from a passive Q&A into a lead generator: when a visitor
    // shows real buying intent, it offers a human follow-up and asks once for
    // contact details. The visitor's reply (a phone/email) is then picked up by
    // the structured-extraction pass in the chat route, which creates the Lead.
