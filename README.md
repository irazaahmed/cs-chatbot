...
- **💬 Also answers on your own WhatsApp number**: connect your own WhatsApp Business number and the exact same AI, same knowledge base, same lead capture, answers there too. Optional add-on, enabled per account: request it from your dashboard after signup.
...
Every plan includes the full website widget product. They differ only in how many pages the bot learns and how many visitor conversations it answers each month. WhatsApp is a separate optional add-on, available on any plan or on its own.
...
- **Baileys** for the WhatsApp add-on, one socket per connected tenant
